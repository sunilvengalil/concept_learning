...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{vae_arch_v4}
...
Figures \ref{classification_acc} shows comparison of classification accuracy for different hyper parameter combinations.
