...
from few_shot.models import VAE
...
args.evaluation_episodes = 1000
args.episodes_per_epoch = 100

if args.dataset == 'omniglot':
    args.n_epochs = 40
    args.dataset_class = OmniglotDataset
    args.num_input_channels = 1
    args.drop_lr_every = 20
elif args.dataset == 'miniImageNet':
    args.n_epochs = 80
    args.dataset_class = MiniImageNet
    args.num_input_channels = 3
    args.drop_lr_every = 40
else:
...
wandb.init(entity="concept_learning", project="baselines", name="EXPERIMENT_NAME",
                           tags="", config=args.__dict__, reinit=True, force=True, dir=f"./wandb/{''}/")
...
# Model #
#########
model = VAE(args.num_input_channels)
...
callbacks = [
    EvaluateFewShot(
        ...
        num_tasks=args.evaluation_episodes,
        n_shot=args.n_test,
        k_way=args.k_test,
